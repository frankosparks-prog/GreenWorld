...
const Medicine = require("./routes/MedicineRoute.js");
const Fertilizer = require("./routes/FertilizerRoute.js");
...
app.use("/api/medicines", Medicine); // Med routes
app.use("/api/fertilizers", Fertilizer); // Fertilizer routes
